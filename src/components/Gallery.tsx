...
const Gallery = () => {
  ...
  return <section id="galeria" className="py-20 bg-gradient-to-br from-industrial-light to-white">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 md:gap-6 mb-16">
          {galleryImages.map((image, index) => <div key={index} className="group relative overflow-hidden rounded-2xl bg-white shadow-industrial hover:shadow-equipment transition-all duration-500 hover:-translate-y-2">
